        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              GradientText(text: "Congrats!", fontSize: 30, fontWeight: FontWeight.bold,),

              SizedBox(height: 11.h,),

              Text(
                "Your Profile is Ready To Use",
                style: GoogleFonts.openSans(fontSize: 23.sp, fontWeight: FontWeight.w600, color: Pallete.primaryWhite),
              ),
